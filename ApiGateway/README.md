...
The API Gateway uses YARP (Yet Another Reverse Proxy) to route requests to backend services:

- `/api/auth/**` - Routes to the Authentication Service
- Other routes can be added in `appsettings.json` under the `ReverseProxy` section
