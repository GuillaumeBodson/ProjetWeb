...
export class SitesService extends BaseService {
    ...
    /**
     * @endpoint get /api/Sites/{siteId}/schedule
     * @param siteId 
     * @param weekNumber 
     * @param numberOfWeeks 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     ...
     * @param options additional options
     */
    public apiSitesSiteIdScheduleGet(siteId: string, weekNumber?: number, numberOfWeeks?: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<Array<TimeSlotResponse>>;
    public apiSitesSiteIdScheduleGet(siteId: string, weekNumber?: number, numberOfWeeks?: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<Array<TimeSlotResponse>>>;
    public apiSitesSiteIdScheduleGet(siteId: string, weekNumber?: number, numberOfWeeks?: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<Array<TimeSlotResponse>>>;
    public apiSitesSiteIdScheduleGet(siteId: string, weekNumber?: number, numberOfWeeks?: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (siteId === null || siteId === undefined) {
            throw new Error('Required parameter siteId was null or undefined when calling apiSitesSiteIdScheduleGet.');
        }
        ...
        let localVarPath = `/api/Sites/${this.configuration.encodeParam({name: "siteId", value: siteId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: "uuid"})}/schedule`;
        const { basePath, withCredentials } = this.configuration;
